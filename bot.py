...
#         lowest = min(lst_scores)
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Activity(type=3,name="SailorDuck Server Answers"))
        await asyncio.sleep(5)
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('Njc4NDY4MTU2Mzg5NDU3OTMw.XkjOvg.vtLaUP3TAGfqGOxbyOH0Jusu220'))
    loop.run_forever()
